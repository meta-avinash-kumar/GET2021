...
product_description varchar(100), category_id int, product_price decimal(10,2), img_id int, 
...
varchar(100), payment_amount decimal(10,2), payment_date date);

create table Orders(order_id int NOT NULL AUTO_INCREMENT primary key, customer_id int, order_date_time 
date, order_amount decimal(19,2), order_status varchar(225), product_id int, payment_id int,foreign
...
customer_mobile varchar(15), customer_email varchar(225), customer_pswd char(60), order_id  int,
